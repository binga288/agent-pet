...
import type { AgentAppConfig, AppSnapshot, PetClickConfig, Preferences } from '../shared/api';
import { pets } from '../shared/pets';
import { ResolvedSprite } from './sprite';
import { labels, providerLabel, sortTasks } from './task-presentation';

export function Panel({state}:{state:AppSnapshot}) {
